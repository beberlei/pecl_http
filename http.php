...
namespace http
{
	class Exception extends \Exception 
	{
		...
		const E_ENCODING = 9;
		const E_CLIENT = 10;
		const E_CLIENT_POOL = 11;
		const E_CLIENT_DATASHARE = 12;
		const E_SOCKET = 14;
		const E_RESPONSE = 15;
		const E_URL = 16;
...
{
	abstract class AbstractClient extends \http\Object implements \SplSubject, \http\Client 
	{
		private $responseMessageClass;
		private $observers;
		private $options;
		...
		public function setRequest(\http\Client\Request $request) {
		}
		...
		public function getResponseMessageClass() {
		}
		public function setResponseMessageClass($message_class_name) {
		}
	}
}
...
namespace http\Client
{
	class CURL extends \http\Client\AbstractClient implements \http\Client, \SplSubject 
	{
...
namespace http\Client
{
	class Factory extends \http\Object 
	{
		...
		protected $clientPoolClass;
		protected $clientDataShareClass;

		public function __construct($options) {
		}
		public function createClient(array $options = NULL) {
		}
		public function createPool(\http\Client $client1 = NULL, \http\Client $client2 = NULL, \http\Client $clientN = NULL) {
		}
		public function createDataShare(\http\Client $client1 = NULL, \http\Client $client2 = NULL, \http\Client $clientN = NULL) {
		}
...
namespace http\Client\DataShare
{
	class AbstractDataShare extends \http\Object implements \Countable 
	{
		public $cookie;
		public $dns;
		public $ssl;
		...
		public function attach(\http\Client $client) {
		}
		public function detach(\http\Client $client) {
		}
...
namespace http\Client\DataShare
{
	class CURL extends \http\Client\DataShare\AbstractDataShare implements \Countable 
	{
	}
}

namespace http\Client\Pool
{
	class AbstractPool extends \http\Object implements \Countable, \Iterator 
	{
		private $client;

		public function __destruct() {
		}
		public function attach(\http\Client\AbstractClient $request) {
		}
		public function detach(\http\Client\AbstractClient $request) {
		}
...
namespace http\Client\Pool
{
	class CURL extends \http\Client\Pool\AbstractPool implements \Iterator, \Countable 
	{
	}
}
